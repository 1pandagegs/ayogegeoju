(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`/assets/logo-C-7YVj-R.png`,t=`/assets/coverage-trackr-D-WLpBeA.png`,n=`/assets/coverage-trackr-D-WLpBeA.png`,r=`/assets/coverage-trackr-D-WLpBeA.png`,i=`/assets/coverage-trackr-D-WLpBeA.png`;document.querySelector(`#app`).innerHTML=`
    ...
    <nav class="fixed top-0 w-full z-50 bg-[#020617]/70 backdrop-blur-xl border-b border-white/5">
      <div class="max-w-6xl mx-auto px-6 h-[76px] flex items-center justify-between">
        <a href="/index.html" class="inline-flex items-center gap-2 text-[15px] font-semibold tracking-[-0.02em] text-white">
          <img src="${e}" alt="Ayo Gegeoju logo" class="h-6 w-auto" />
        </a>
        ...
        <div class="grid md:grid-cols-[220px_1fr] gap-10 md:gap-16">
          ...
          <div class="fade-up fade-delay-1">
            ...
            <div class="space-y-0">
              ...
              ${[{number:`01`,title:`Home and Abroad`,type:`PropTech / Real Estate`,desc:`A diaspora-focused property platform designed to make remote property discovery feel more trustworthy, structured, and easier to navigate.`,href:`/work-home-and-abroad.html`,image:t},{number:`02`,title:`Hemo Trackr`,type:`HealthTech / System Design`,desc:`A blood inventory and donor management experience built to improve visibility, speed up coordination, and support faster response in urgent situations.`,href:`/work-hemo-trackr.html`,image:n},{number:`03`,title:`Coverage Trackr`,type:`Operations / Planning Tool`,desc:`A planning and monitoring tool created to support smarter operational decisions, better resource allocation, and clearer coverage visibility.`,href:`/work-coverage-trackr.html`,image:r},{number:`04`,title:`More Projects`,type:`Product Design / Digital Experience`,desc:`Additional work across digital products, web experiences, interface systems, and design thinking for different industries and use cases.`,href:`/work.html`,image:i}].map(e=>`
                <article class="group border-t border-white/10 py-10 md:py-12">
                  <div class="grid md:grid-cols-[72px_minmax(0,1fr)_180px] gap-6 md:gap-8 items-start">
                    ...
                    <div class="flex flex-col items-start md:items-end gap-4 pt-1">
                      ...
                      <a href="${e.href}" class="group inline-flex items-center gap-2 text-sm font-medium text-white/70 hover:text-white transition-colors duration-200">
                        View project
                        <span class="transition-transform duration-200 group-hover:translate-x-1">↗</span>
                      </a>
                    </div>
...
`;var a=document.querySelector(`#mobile-menu-toggle`),o=document.querySelector(`#mobile-menu`),s=document.querySelectorAll(`#mobile-menu a`);a&&o&&(a.addEventListener(`click`,()=>{o.classList.toggle(`hidden`)}),s.forEach(e=>{e.addEventListener(`click`,()=>{o.classList.add(`hidden`)})}));var c=document.querySelector(`#page-root`);c&&requestAnimationFrame(()=>{c.classList.add(`page-enter-active`)});